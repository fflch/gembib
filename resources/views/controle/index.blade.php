...
<div class="form-row">
    ...
    <input id="inicio" style="width: 400px" class="datepicker" value="{{ old('inicio', $controle->inicio) }}" name="inicio"/><br><br>
</div>
    <div class="col-md-3 mb-3">
        <label for="fim">Data fim:</label><br>
        <input id="fim" style="width: 400px" class="datepicker" value="{{old('fim', $controle->fim)}}" name="fim"/><br><br>
    </div>
    <div class="col-md-3 mb-3">
